...
class Database {
    ...
    /** @var int Port de la base de données */
    private $port;
    ...
    public function connect() {
        try {
            ...
            // Journaliser le détail technique uniquement dans les logs.
            ...
            // Ne jamais exposer le message PDO au navigateur, même hors production.
